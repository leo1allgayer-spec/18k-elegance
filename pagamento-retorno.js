(function(){
  ...
  const labels={paid:['Pagamento confirmado!','Seu pedido foi recebido e já aparece no painel da Elegance.'],payment_review:['Pagamento recebido — pedido em análise','A Elegance precisa conferir a disponibilidade dos itens antes de confirmar a entrega. Entre em contato com a loja informando o número do pedido.'],pending_payment:['Pagamento em processamento','Estamos aguardando a confirmação do Mercado Pago.'],cancelled:['Pagamento não concluído','Você pode voltar à sacola e tentar novamente.'],refunded:['Pagamento devolvido','O pagamento foi estornado pelo Mercado Pago.']};
